...
## [2.7.0](https://github.com/8digit/picpeak/compare/v2.6.5...v2.7.0) (2026-04-27)


### Features

* add admin dark mode and SEO/robots.txt settings ([9c2a0d2](https://github.com/8digit/picpeak/commit/9c2a0d272a21dfcace2ec795034e2f1adcba47e0))
* add Apple Liquid Glass templates, image security settings, and automated releases ([6033461](https://github.com/8digit/picpeak/commit/6033461be118ce78277ec568e1ef1ceeff7311c8))
* add bulk category editing for photos ([#157](https://github.com/8digit/picpeak/issues/157)) ([eca36c7](https://github.com/8digit/picpeak/commit/eca36c70a23f18f937a9f5bddeff855e18f364c3))
* add category hero/cover photo selection ([#163](https://github.com/8digit/picpeak/issues/163)) ([6c30e2c](https://github.com/8digit/picpeak/commit/6c30e2c2edd19a24d4f30a9558690bb7e2331b32))
* add configurable upload batch size for reverse proxy compatibility ([#208](https://github.com/8digit/picpeak/issues/208)) ([02a46e0](https://github.com/8digit/picpeak/commit/02a46e083d68cfdb355b5a4fe4a8da7d667050b9))
* Add CSS template system with custom gallery styling support ([0da45e6](https://github.com/8digit/picpeak/commit/0da45e699ad998031aa56a92f2da5ee61a04e285))
* add customizable event types with admin management ([f8881d5](https://github.com/8digit/picpeak/commit/f8881d5bd62d449fb40917ec8c20f0eb16c1fdad))
* add event management, gallery customization, and release automationFeature/event rename ([40ee671](https://github.com/8digit/picpeak/commit/40ee67171d41522037bf9d4e7675b62ec564346d))
* add Gallery Premium and Gallery Story layouts (Beta) ([e179def](https://github.com/8digit/picpeak/commit/e179def3cceefe5fd6acd5574f2986e4f9e223ef))
* add GitHub Actions workflow for Docker image builds ([4029559](https://github.com/8digit/picpeak/commit/40295599547b86af7fea3359c7486918d2cd0236))
* add hero image focal point picker with anchor positioning ([#162](https://github.com/8digit/picpeak/issues/162)) ([734868a](https://github.com/8digit/picpeak/commit/734868abc23731b0ac9ad73e799194df1e6aa6ab))
* add justified layout modes and aspect-ratio-aware mosaic ([#146](https://github.com/8digit/picpeak/issues/146)) ([608bbd5](https://github.com/8digit/picpeak/commit/608bbd50e7b31d49c7516a00e96f284fa16e2777))
* Add justified layout modes and aspect-ratio-aware mosaic ([#146](https://github.com/8digit/picpeak/issues/146)) ([ef2ae00](https://github.com/8digit/picpeak/commit/ef2ae00ff20b754c2f2ed797e18c146d12d7f31a))
* add justified/rows layout mode to masonry gallery ([#146](https://github.com/8digit/picpeak/issues/146)) ([e081b56](https://github.com/8digit/picpeak/commit/e081b56a44bf9fdaa3dd225d5dd4dde35bfe83d3))
* add justified/rows layout mode to masonry gallery ([#146](https://github.com/8digit/picpeak/issues/146)) + security fixes ([cd1d504](https://github.com/8digit/picpeak/commit/cd1d50474f673b759c2f9401fdbe209a84773e39))
* add multi-administrator support with RBAC and fix backup/restore for S3 ([892e47d](https://github.com/8digit/picpeak/commit/892e47d017064d7922536f8e138bbb290a45cdc9))
* add optional event date and expiration settings ([3079eaa](https://github.com/8digit/picpeak/commit/3079eaa2e5d1728c2c0f315626cc253e4b08edc2))
* add optional event date and expiration settings ([2151147](https://github.com/8digit/picpeak/commit/2151147f2d3134448ff32130da44678e2942d73c)), closes [#118](https://github.com/8digit/picpeak/issues/118)
* add original filename preservation and Lightroom export support ([a59f414](https://github.com/8digit/picpeak/commit/a59f41463f960a3a74ce3933dc7db84ee3a2018d))
* add original filename preservation and Lightroom export support ([9872ad3](https://github.com/8digit/picpeak/commit/9872ad3aef6488b359c5499a6dc3d8bfbfa48fde))
* add per-event custom logo upload with bug fixes ([85170b8](https://github.com/8digit/picpeak/commit/85170b883f504d83f1d862abb3f4e46741074826))
* add per-event hero logo customization options ([0790a1d](https://github.com/8digit/picpeak/commit/0790a1ddad774af89827a0a392e9fae0a945bff2))
* add quilted layout, fix mosaic, and backfill photo dimensions ([#146](https://github.com/8digit/picpeak/issues/146)) ([46ed1bc](https://github.com/8digit/picpeak/commit/46ed1bc276867a25b27bf22cd9b9d7e879a6947b))
* add thumbnail settings UI to admin panel ([3a30fea](https://github.com/8digit/picpeak/commit/3a30fea862034d64fbc7188fc25292594a9319e2))
* add thumbnail settings UI to admin settings page ([#206](https://github.com/8digit/picpeak/issues/206)) ([7d6d2f5](https://github.com/8digit/picpeak/commit/7d6d2f56883a4402f0d97c95b0432a8a783c8024))
* add update instructions dialog, email notifications, and capture date sorting ([50c0990](https://github.com/8digit/picpeak/commit/50c09904a9434f988ab32a07da5d24db0e02065e)), closes [#181](https://github.com/8digit/picpeak/issues/181)
* **admin:** external media import modal + thumbnail fixes for reference events\n\n- Photos tab: replace inline external folder picker with a modal opened via "Import from External Folder" button next to "Upload Photos"; add info that all pictures in the selected folder will be imported.\n- Admin thumbnails: align list endpoint to /api/admin/photos/:eventId/photos and always return thumbnail_url to trigger on-demand generation; normalize external paths to avoid duplicated folder segments (e.g., individual/individual) that broke resolver; improve thumbnail logging.\n- Use authenticated image fetching on admin feedback pages to prevent 401s in automation.\n- i18n: add backup.external.warning strings; complete German backup/restore coverage; add common keys (notSet, of, up, select, selected).\n- Docs: add Local (npm) setup for EXTERNAL_MEDIA_ROOT in deployment guide.\n\nRefs [#17](https://github.com/8digit/picpeak/issues/17) – gallery feature request: https://github.com/the-luap/picpeak/issues/17 ([49c7778](https://github.com/8digit/picpeak/commit/49c77785e7a776890f15c0c541dcd18b74a86c6e))
* **admin:** implement 30-day session for Remember Me checkbox ([d062865](https://github.com/8digit/picpeak/commit/d062865b789b9ac1e3c98297db65f08fead2d6df))
* **admin:** refine header layout and logo placement ([d64e7d0](https://github.com/8digit/picpeak/commit/d64e7d08deae7ad1b6f744f447fe546115427942))
* allow admin email updates in UI ([#36](https://github.com/8digit/picpeak/issues/36)) ([3c2a79a](https://github.com/8digit/picpeak/commit/3c2a79a31a0f1a44c8ec4f9a87f6fbcea9be651c))
* beta/stable release channels with update notifications and bug fixes ([3c7dc20](https://github.com/8digit/picpeak/commit/3c7dc2013fc3b57712ddf16db85f495b3cc7bfd7))
* beta/stable release channels with update notifications and bug fixes ([#98](https://github.com/8digit/picpeak/issues/98)) ([3c7dc20](https://github.com/8digit/picpeak/commit/3c7dc2013fc3b57712ddf16db85f495b3cc7bfd7))
* configurable upload batch size for reverse proxy compatibility ([9b7495e](https://github.com/8digit/picpeak/commit/9b7495e0054975e66c9b5006c24a9fae63969de4))
* configurable upload batch size for reverse proxy compatibility ([4243363](https://github.com/8digit/picpeak/commit/424336340bef8e1629490ade154f0ceebb2a71e1))
* consolidate setup scripts and guides into unified solution ([29a8ff9](https://github.com/8digit/picpeak/commit/29a8ff914cf838918ab827280e4415afbce5ca8d))
* decouple hero header from gallery layouts ([#158](https://github.com/8digit/picpeak/issues/158)) ([7b8d8bd](https://github.com/8digit/picpeak/commit/7b8d8bd92ba7a96717bb4d821b38dddc395f701a))
* **docker:** add PUID/PGID and user mapping to avoid bind mount permission issues; feat(setup): prompt for admin email interactively; docs: PUID/PGID in .env.example ([410a33f](https://github.com/8digit/picpeak/commit/410a33fecf1693cc75816c53ac460ec20089e2a1))
* dynamic website title from branding settings ([d29aab7](https://github.com/8digit/picpeak/commit/d29aab7c70c5777451666fb7d5c7a9729dab684a))
* **events:** add CSS template selector to event edit page ([6a6c2cd](https://github.com/8digit/picpeak/commit/6a6c2cd34db26a53b5fb96415650e8136a74e47f))
* **feedback:** pivot CSV export to one row per photo+guest ([ed7943b](https://github.com/8digit/picpeak/commit/ed7943be5cbef16c5ca5321f6fc69329df15e086))
* gallery layouts, bulk category editing, and hero header improvements ([7037106](https://github.com/8digit/picpeak/commit/7037106bff62593bba600d898a781f79f07b459d))
* gallery layouts, hero customization, bulk categories & event types ([d9e00dc](https://github.com/8digit/picpeak/commit/d9e00dc0dbd7cef0ddb4665e5306c98aac3573e3))
* gallery layouts, hero customization, event types, and UX improvements ([#146](https://github.com/8digit/picpeak/issues/146), [#155](https://github.com/8digit/picpeak/issues/155)-163, [#170](https://github.com/8digit/picpeak/issues/170), [#171](https://github.com/8digit/picpeak/issues/171)) ([4280444](https://github.com/8digit/picpeak/commit/4280444d70e73db09e67e18ce25bac75cf499b75))
* **gallery/filters:** add Rated and Commented filters (UI + backend).\n\n- UI: add star (Rated) and message (Commented) buttons to feedback filter bars (desktop + mobile)\n- Backend: support filter=rated, commented, and combinations via aggregate counts/queries ([b03760a](https://github.com/8digit/picpeak/commit/b03760ab01e21feb3578f90d065945d437d03452))
* **gallery:** add quick Like/Favorite actions on thumbnails across layouts ([6368f10](https://github.com/8digit/picpeak/commit/6368f1027f96107ba64964eb126911bfe185f54a))
* **gallery:** always-visible feedback indicators on grid tiles; fallback image rendering in lightbox/hero; auto-auth from shared-link token; fix external photo resolver\n\n- GridGallery: bottom-left icons for like/rated/comment on every tile\n- Hero layout grid: added same indicators (non-intrusive icons)\n- Lightbox/Hero: add fallbackSrc to display thumbnail if original fails\n- GalleryAuth: auto-store token from /gallery/:slug/:token and hydrate event\n- Backend gallery photo route: use resolvePhotoFilePath for external-media\n\nfix(admin): move photo feedback badges to bottom-right on admin grid tiles\n\nfix(dashboard): add missing i18n keys for activity types + fallback to formatter\n\nfix(admin/feedback): correct thumbnail URL base + robust date parsing\n\nRefs: [#19](https://github.com/8digit/picpeak/issues/19) ([6948aaa](https://github.com/8digit/picpeak/commit/6948aaa92afc29609f85cf7fd631095f3e32ad3f))
* **gallery:** compact vertical icon-only feedback filter in PhotoFilterBar; remove wide buttons to prevent overflow\n\n- Desktop: vertical icon stack (All/Grid, Likes, Favorites) outside scroll area\n- Mobile: vertical icon stack below categories\n- Keeps existing category bar layout and count\n\nRefs: [#19](https://github.com/8digit/picpeak/issues/19) ([465f997](https://github.com/8digit/picpeak/commit/465f997752fc930ac0a3ae530e9e57a378877d53))
* **i18n:** add translations for settings tabs ([c030e87](https://github.com/8digit/picpeak/commit/c030e872135b39701ef1f4bbb2f28bcaf4ce7fae))
* implement 4 new features with bug fixes and refactoring plan ([77a4bfd](https://github.com/8digit/picpeak/commit/77a4bfd49975551bf509354097f280cab3e48c7a))
* implement beta/stable release channels with update notifications ([617e778](https://github.com/8digit/picpeak/commit/617e778a48e0f0c24fcb8441d00ed2a816f19c03))
* implement feedback filter for liked/favorited photos (Issue [#17](https://github.com/8digit/picpeak/issues/17)) ([41857ec](https://github.com/8digit/picpeak/commit/41857ec499e2aab4347173cb031db246b9a032f6))
* implement gallery logo customization (Issue [#17](https://github.com/8digit/picpeak/issues/17)) ([909e760](https://github.com/8digit/picpeak/commit/909e760447c76bb35dbffa553a4665edc5ebccd9))
* improve gallery layouts with aspect-ratio-aware masonry and mosaic modes ([#146](https://github.com/8digit/picpeak/issues/146)) ([aacfcd5](https://github.com/8digit/picpeak/commit/aacfcd517ea5739e834cf84627b55b3449740a5c))
* improve hero image UX and live preview ([#163](https://github.com/8digit/picpeak/issues/163), [#158](https://github.com/8digit/picpeak/issues/158)) ([d63f67a](https://github.com/8digit/picpeak/commit/d63f67a2afba1b92610382aa1012428ccacb86bd))
* **lightbox:** keep feedback usable while navigating ([6368f10](https://github.com/8digit/picpeak/commit/6368f1027f96107ba64964eb126911bfe185f54a)), closes [#19](https://github.com/8digit/picpeak/issues/19)
* Multi-administrator RBAC, CSS templates & security hardening ([#78](https://github.com/8digit/picpeak/issues/78)) ([16b3ab0](https://github.com/8digit/picpeak/commit/16b3ab039ae95f5641dc15a4811eb2b503f1791c))
* **native:** auto-serve SPA when dist exists (unless SERVE_FRONTEND=false); add clear logging; serve index.html for /admin ([fb16b7b](https://github.com/8digit/picpeak/commit/fb16b7bbb8225192160c08050f1b164c36c8dc74))
* **native:** build frontend and serve SPA from backend (SERVE_FRONTEND); fix Cannot GET /admin on native installs ([9fe10bc](https://github.com/8digit/picpeak/commit/9fe10bcce2871a48f2409b4936d95c00249deb51))
* **native:** serve built frontend from backend; build frontend during install/update; ensure env flags (SERVE_FRONTEND, FRONTEND_DIR) ([61ad2d6](https://github.com/8digit/picpeak/commit/61ad2d61c137196c229817989f991e50fa389a6e))
* new features and bug fixes for beta release ([151e1bf](https://github.com/8digit/picpeak/commit/151e1bf50f206ae0571fa044c75b8bc9f0f40120))
* original filename in admin UI, update dialog, and security hardening ([3ea9d5b](https://github.com/8digit/picpeak/commit/3ea9d5b1219980032cbee7a2564c0004948923f5))
* original filename in admin UI, update dialog, security hardening, and bug fixes ([bcf2745](https://github.com/8digit/picpeak/commit/bcf2745ab64acb968ae4bd0710b28e78c14f340c))
* overhaul public landing page and backup tooling ([2a4d388](https://github.com/8digit/picpeak/commit/2a4d38813f7ab64a6bbb3a666f3c98a29443488d))
* per-event custom logos, customizable event types, and multiple bug fixes ([4c08160](https://github.com/8digit/picpeak/commit/4c081601e02888d7ad289acb7847aee9d6f5703f))
* pre-generate watermarks for instant lightbox loading ([1be974a](https://github.com/8digit/picpeak/commit/1be974afbb0b7a1bdbdd140327771907a5d3c2ae)), closes [#112](https://github.com/8digit/picpeak/issues/112)
* pre-generated watermarks and mobile upload button improvements ([c6fdd38](https://github.com/8digit/picpeak/commit/c6fdd38e842e1a8c0aa9cbab9fc791e6669e402d))
* **select:** add per-tile checkbox selection in Admin grid and all gallery layouts; tile click opens viewer; checkbox toggles selection; auto-enable selection mode; add testids ([9fda54b](https://github.com/8digit/picpeak/commit/9fda54bd06d37cd8f8f71056bf4f59e158cd8112))
* **setup/docker:** auto-set PUID/PGID from invoking user and chown bind-mount folders; create missing data/events dirs ([0618b78](https://github.com/8digit/picpeak/commit/0618b78725e85f97f0a4b4e834c17811c033c8f4))
* **setup:** remove --admin-password; print admin credentials from ADMIN_CREDENTIALS.txt; fix ADMIN_URL to avoid /admin/admin; update native service commands ([84d0f63](https://github.com/8digit/picpeak/commit/84d0f63d36c68532fea83e7087b1afeaa9b82f39))
* show original filename in admin UI ([#184](https://github.com/8digit/picpeak/issues/184)) ([0891be1](https://github.com/8digit/picpeak/commit/0891be197fdb7d92ade5a293b8db0bed26fa6e3a))
* support per-gallery password toggle ([5d6c061](https://github.com/8digit/picpeak/commit/5d6c061f1c4fd20581b1e74fa114c96530b5de53))


### Bug Fixes

* add allow_user_uploads to gallery API responses ([691e3ab](https://github.com/8digit/picpeak/commit/691e3aba09f2148afe902a0bb0139d062634e669))
* add lightbox loading spinner and watermark cache invalidation ([050ed37](https://github.com/8digit/picpeak/commit/050ed378199eb3b15c7c7f243792f68f858803f5))
* Add settings translations and fix manual backup process ([#82](https://github.com/8digit/picpeak/issues/82)) ([476fcce](https://github.com/8digit/picpeak/commit/476fcce13f30f9f2d2f98a0c87c25fba09e9eebc))
* add STORAGE_PATH to production docker-compose ([cdda709](https://github.com/8digit/picpeak/commit/cdda70988664a177b351abc6a259ec39664d17ff))
* **admin/feedback:** use correct event id when rendering photo thumbnails ([4c7b49a](https://github.com/8digit/picpeak/commit/4c7b49a5f69a3fce4f9a0e837a082b56bb7e47d6)), closes [#19](https://github.com/8digit/picpeak/issues/19)
* **admin:** prevent category badge overlap in grid ([d64e7d0](https://github.com/8digit/picpeak/commit/d64e7d08deae7ad1b6f744f447fe546115427942))
* **admin:** replace window.confirm() with in-app ConfirmDialog ([88bfde1](https://github.com/8digit/picpeak/commit/88bfde1fdddc18c582fc842dd2eddbfd663c8bf8))
* align backend port to 3000 across all configurations ([3a8d53f](https://github.com/8digit/picpeak/commit/3a8d53f4927f577c4031c4bc3531e08191dc632a))
* Align nginx backend port for production Docker deployments (v2.2.2) ([#88](https://github.com/8digit/picpeak/issues/88)) ([e0bd19a](https://github.com/8digit/picpeak/commit/e0bd19a74dd81bdd45be2384820830bd96769e1c))
* **backup:** add lastBackup alias and totalBackups for frontend compatibility ([749100c](https://github.com/8digit/picpeak/commit/749100c92abd2bb123b137e3d3c6bb342b8f5f00))
* **backup:** allow manual backups when automated backups are disabled ([e6dd89e](https://github.com/8digit/picpeak/commit/e6dd89e969fb7018633159155975bd2bd2fb0409))
* **branding:** remove PicPeak logo fallback from all gallery surfaces ([d425175](https://github.com/8digit/picpeak/commit/d42517500e746eba3ae958d5d229e42b438fdb46))
* checkbox and toggle settings not persisting after page refresh ([808ed1d](https://github.com/8digit/picpeak/commit/808ed1d2f1164d9fd1114586c68a1f925bf73ddf)), closes [#117](https://github.com/8digit/picpeak/issues/117)
* CI workflow fixes for protected branches ([657c205](https://github.com/8digit/picpeak/commit/657c205a4d8ca49070b69973f4c7a3d1418633af))
* CI workflow fixes for protected branches ([cb01218](https://github.com/8digit/picpeak/commit/cb012186d93403a1ac4e2d2f5283319603b290d6))
* **ci:** add QEMU setup for multi-arch builds and skip for PRs ([0d36a27](https://github.com/8digit/picpeak/commit/0d36a273bb58ffd0172efacd828e7171d954b41c))
* clear notifications via API ([#35](https://github.com/8digit/picpeak/issues/35)) ([013be18](https://github.com/8digit/picpeak/commit/013be18d982986333e2ac24c7ede907de49690bc))
* correct invitation activation validation and add missing translations ([991aa98](https://github.com/8digit/picpeak/commit/991aa98f98cffd1d7785c272726615325e2c0208)), closes [#129](https://github.com/8digit/picpeak/issues/129)
* correct invitation email link URL path ([86fa104](https://github.com/8digit/picpeak/commit/86fa1046d5439cb451feb164175c919c49ca219a)), closes [#129](https://github.com/8digit/picpeak/issues/129)
* correct malformed gallery URLs in admin panel View Gallery links ([3074748](https://github.com/8digit/picpeak/commit/3074748bbc6a8cb8fc0e95d2f24d626f0d0444d0))
* correct password generator function name in reset password route ([65d796b](https://github.com/8digit/picpeak/commit/65d796b9f09417f85bb3209c5e5fbe597a4bb2d3))
* correct script name in Gitea mirror workflow ([828d6bc](https://github.com/8digit/picpeak/commit/828d6bc456175007b72998db7116eec993750435))
* correct storage path resolution in multiple files ([#96](https://github.com/8digit/picpeak/issues/96)) ([0e3674b](https://github.com/8digit/picpeak/commit/0e3674b2b0325bbcee5aa2c9ff7781da92f612d1))
* correct storage path resolution in multiple files ([#96](https://github.com/8digit/picpeak/issues/96)) ([3ccb815](https://github.com/8digit/picpeak/commit/3ccb8154eb40a432aa467fb06b3f216fd0d2c6b4))
* **cors:** scope CORS to /api only and avoid throwing on disallowed origins; prevents static asset 500s on native ([90bb21e](https://github.com/8digit/picpeak/commit/90bb21e38bf1ba97e3fb8185b8d05f1296d745ee))
* database migration restart bug, lightbox loading spinner, and watermark cache invalidation ([7c58749](https://github.com/8digit/picpeak/commit/7c5874980640ae8c3d1050ce24daeb0a2aeab7a3))
* **db:** improve PostgreSQL connection check in wait-for-db.sh ([e85a68a](https://github.com/8digit/picpeak/commit/e85a68a386c72c276b4958599b5246e60dfac716))
* display new password after admin password reset ([bd8b885](https://github.com/8digit/picpeak/commit/bd8b885f7f060160eb852870d143f25ce628f3db))
* docker compose v2 syntax and add missing ADMIN_PASSWORD to .env.example ([#189](https://github.com/8digit/picpeak/issues/189)) ([0817443](https://github.com/8digit/picpeak/commit/0817443e793e37c770c6a1968ecae4b9464107b0))
* Docker Swarm DNS resolution and backup status display (v2.2.3) ([082d8ab](https://github.com/8digit/picpeak/commit/082d8ab2054416b2a4f9e0438aa2bda0a8f4277e))
* Docker Swarm DNS resolution and backup status display (v2.2.3) ([082d8ab](https://github.com/8digit/picpeak/commit/082d8ab2054416b2a4f9e0438aa2bda0a8f4277e))
* dynamic website title from branding settings ([4701edc](https://github.com/8digit/picpeak/commit/4701edc12ecfab27cb2d1cfb0b4ed4fd53f56cc6))
* event-specific custom CSS settings not being saved ([dadef81](https://github.com/8digit/picpeak/commit/dadef81158972d28aa32812203500f77ed08a999)), closes [#136](https://github.com/8digit/picpeak/issues/136)
* events without expiration date incorrectly shown as expired ([c4f16eb](https://github.com/8digit/picpeak/commit/c4f16eb76c909158abdb63aa4cc22f817f274dc5))
* **feedback:** fix three silent failure bugs in gallery feedback submission ([c80e638](https://github.com/8digit/picpeak/commit/c80e6387547f59c1d11fe2243bef1bcd792b74f3))
* **frontend:** add missing externalMedia service and mount admin external-media routes; verify Vite build ([ab324f1](https://github.com/8digit/picpeak/commit/ab324f192859204a3ea3c129530ccfe8f5a36968))
* gallery thumbnails not loading (404 errors) [#96](https://github.com/8digit/picpeak/issues/96) ([e3c3c4c](https://github.com/8digit/picpeak/commit/e3c3c4c951c52de99bd0afd95b08d119153997b4))
* **gallery/filters:** always apply global liked/favorited filters by aggregate counts (ignore guest_id); resolves mismatch between client guest_id and server identifier ([526dcd8](https://github.com/8digit/picpeak/commit/526dcd8dfc030d86143cee799a88a1004d96b116))
* **gallery/filters:** make feedback filters work globally when no guest_id is provided; remove guest_id from client photos query\n\n- Backend /api/gallery/:slug/photos: if filter present and guest_id missing, filter by like_count/favorite_count\n- Frontend useGalleryPhotos: stop passing random guestId (does not match server guest_identifier)\n\nThis makes Liked/Favorited filters reflect photos with aggregate feedback counts as expected. ([5b2561b](https://github.com/8digit/picpeak/commit/5b2561b6f1da2665d6092ba954f8ff26df3959a4))
* **gallery/sidebar:** compact icon-only feedback filter in sidebar (vertical, small) to avoid overflow; use GalleryFilter variant=compact ([ff89f96](https://github.com/8digit/picpeak/commit/ff89f96e31130f75bcd7a406c5d895eac17b65de))
* **gallery:** apply branding logo and hide_powered_by in Premium and Story layouts ([58ca5a3](https://github.com/8digit/picpeak/commit/58ca5a37a408a469d7acd9f69a5c0bbf3a260ae4))
* **gallery:** feedback filter headline + horizontal icons in sidebar (compact variant); ensure sidebar content scrolls (flex-col container) ([3a6d061](https://github.com/8digit/picpeak/commit/3a6d06192a280ead8bd5d1fbfe06554e63f3346e))
* **gallery:** stream ZIP downloads natively to fix iOS Safari memory stall ([0de319e](https://github.com/8digit/picpeak/commit/0de319e9106a36bd4537a214de25c035bd53d04c))
* **gallery:** trigger download-all click inside user gesture (Safari) ([a52b49a](https://github.com/8digit/picpeak/commit/a52b49acd30a853dd83af0d1305ddd480b0eda67))
* handle legacy non-JSON logo paths when replacing logo ([0d5ce48](https://github.com/8digit/picpeak/commit/0d5ce48dccf0c61f210725ffae15dafc5e9f7cab))
* handle null dates in dashboard and gallery pages ([c5a8ffc](https://github.com/8digit/picpeak/commit/c5a8ffc08cd4c53c37fe4fb9cde8519a68f1f343))
* harden gallery downloads and per-gallery auth ([fc1bf53](https://github.com/8digit/picpeak/commit/fc1bf534129092ca3638e4a4bc47274cd297fa5f))
* hero header state and preview in admin theme editor ([#158](https://github.com/8digit/picpeak/issues/158)) ([f554f46](https://github.com/8digit/picpeak/commit/f554f463b3492346dba067c0980b52ef42dd5e70))
* improve ghost button visibility in admin dark mode ([4912e2b](https://github.com/8digit/picpeak/commit/4912e2bccf282134d5598a8ac80942ed46d0523c))
* improve password validation errors and event list UX ([#170](https://github.com/8digit/picpeak/issues/170), [#171](https://github.com/8digit/picpeak/issues/171)) ([171abb3](https://github.com/8digit/picpeak/commit/171abb31615484d77cf95a99cb5634afa0160adc))
* improve photo serving, category filters, and upload chunking ([#155](https://github.com/8digit/picpeak/issues/155), [#156](https://github.com/8digit/picpeak/issues/156), [#161](https://github.com/8digit/picpeak/issues/161)) ([fa4c838](https://github.com/8digit/picpeak/commit/fa4c83812d87cfa63394e51186e320a072929d37))
* increase upload limit to 1GB and fix category filters ([#155](https://github.com/8digit/picpeak/issues/155), [#156](https://github.com/8digit/picpeak/issues/156)) ([397d33a](https://github.com/8digit/picpeak/commit/397d33a95a09e0b0986c3f6cf5965c544992a764))
* issue [#203](https://github.com/8digit/picpeak/issues/203) file type validation + security CVE fixes ([8017171](https://github.com/8digit/picpeak/commit/80171713e0ffedda56f7cffb403b25a8d55634d1))
* JSON serialize favicon and logo URLs for PostgreSQL storage ([b83f427](https://github.com/8digit/picpeak/commit/b83f4272b584f937fea1f47656182e514b12d980))
* lightbox watermark loading, white label translations, and dynamic footer year ([3b720ed](https://github.com/8digit/picpeak/commit/3b720ed56ecd2ded6aec57309f8c408c63a617ef))
* lightbox watermark loading, white label translations, and dynamic footer year ([ce8587b](https://github.com/8digit/picpeak/commit/ce8587b24df3f53a11a74348eff8b5c5b96c5488))
* lightbox watermark loading, white label translations, and dynamic footer year ([#108](https://github.com/8digit/picpeak/issues/108)) ([3b720ed](https://github.com/8digit/picpeak/commit/3b720ed56ecd2ded6aec57309f8c408c63a617ef))
* mobile upload button not visible in gallery ([#113](https://github.com/8digit/picpeak/issues/113)) ([cacaffa](https://github.com/8digit/picpeak/commit/cacaffa5c39f67105c4cfb092ea62157121fb72e))
* mobile upload button visibility in gallery ([2a2c23d](https://github.com/8digit/picpeak/commit/2a2c23d11610e6c81684163eb4ea934a6d6104fb)), closes [#113](https://github.com/8digit/picpeak/issues/113)
* mobile upload button visibility in gallery ([df7dbff](https://github.com/8digit/picpeak/commit/df7dbffbffb180e62af0d2b58326f9de0f515439)), closes [#113](https://github.com/8digit/picpeak/issues/113)
* mobile upload button visibility in gallery ([#113](https://github.com/8digit/picpeak/issues/113)) ([05a5307](https://github.com/8digit/picpeak/commit/05a5307e22dc45be4b75b2996ff9fac65dec399d))
* mobile upload button visibility in gallery ([#113](https://github.com/8digit/picpeak/issues/113)) ([6cb4342](https://github.com/8digit/picpeak/commit/6cb43428d1e703267edeacda9ede050a8c4f8e0c))
* Multi-administrator RBAC, CSS templates & security hardening ([#80](https://github.com/8digit/picpeak/issues/80)) ([37d4e1c](https://github.com/8digit/picpeak/commit/37d4e1cb6132346699a90aebfbaec83d84f931f4))
* **native/http:** disable CSP upgrade-insecure-requests and HSTS unless ENABLE_HSTS=true; prevents HTTPS upgrades on HTTP installs ([24b4a31](https://github.com/8digit/picpeak/commit/24b4a314a9e97b6c640ca29067e95028a23a8973))
* **native:** correct setup paths to /opt/picpeak/app, update repo URL, add sqlite prod support; docs path fixes ([b992b15](https://github.com/8digit/picpeak/commit/b992b151d3ca6ccb4a9b2434d94edcdc90ada3b0))
* **native:** remove obsolete workers service; restart only backend; add API request logging and preflight handler; keep static assets outside CORS ([f3604b4](https://github.com/8digit/picpeak/commit/f3604b438b37e5f2bddf98e79f458bfa2367cb75))
* **nginx:** add Docker DNS resolver for Swarm/dynamic service discovery ([049837f](https://github.com/8digit/picpeak/commit/049837f9d675ff5a4d93c02e5eb771bf65bc2616))
* **nginx:** Add Docker DNS resolver for Swarm/dynamic service discovery (v2.2.3) ([cc1ddfd](https://github.com/8digit/picpeak/commit/cc1ddfd42cccac07d5869fe2ee19c25a9ffa50e8))
* **photos:** category changes now persist and display correctly ([#77](https://github.com/8digit/picpeak/issues/77)) ([d9da98c](https://github.com/8digit/picpeak/commit/d9da98c355011c247c526b28e6f07b329a632b55))
* **photos:** resolve upload category selection and improve feedback buttons ([#77](https://github.com/8digit/picpeak/issues/77)) ([856d533](https://github.com/8digit/picpeak/commit/856d53343c6805706e1498892a29b120938f8547))
* prefer admin token on admin routes ([#23](https://github.com/8digit/picpeak/issues/23) [#28](https://github.com/8digit/picpeak/issues/28)) ([d4404e3](https://github.com/8digit/picpeak/commit/d4404e39bd7953649da02d3e300ffef46573ac97))
* prevent database migration restart failures ([83a4344](https://github.com/8digit/picpeak/commit/83a4344a01de4f65c5024fdf2d177a04457ccd2f)), closes [#107](https://github.com/8digit/picpeak/issues/107)
* prevent unnecessary image recompression and fix SQLite migration [#95](https://github.com/8digit/picpeak/issues/95) ([3cdc0ea](https://github.com/8digit/picpeak/commit/3cdc0ea7152e63cd72124a91394741a6e6904af3))
* **preview:** forward ?preview token in AuthenticatedImage fetches ([e1c8a35](https://github.com/8digit/picpeak/commit/e1c8a35330e54614e47ec67b9cb4eb4fcc5fddd6))
* remove non-functional watermark toggle from Feature Toggles ([d4a15db](https://github.com/8digit/picpeak/commit/d4a15dbe74d0d70bbe6ff03362dc7337fb8f4c5c))
* remove unnecessary publish-manifest job from Docker workflow ([986b101](https://github.com/8digit/picpeak/commit/986b101040674f2253fcdfda99a9e603535daaa0))
* remove updated_at field from password reset query ([ed0243e](https://github.com/8digit/picpeak/commit/ed0243ec398acca26490ef27cbe3cfe5fa9b95a6))
* render minimal/none header styles, cap hero height, switch category hero images ([#158](https://github.com/8digit/picpeak/issues/158), [#162](https://github.com/8digit/picpeak/issues/162), [#163](https://github.com/8digit/picpeak/issues/163)) ([bc6c48b](https://github.com/8digit/picpeak/commit/bc6c48bb2429505c2de3641693a8ff4f623a4951))
* resend gallery email fails for events without password ([6b3ead7](https://github.com/8digit/picpeak/commit/6b3ead747b1395d8ea2b3d135a5ac24db05e2eb8)), closes [#137](https://github.com/8digit/picpeak/issues/137)
* resolve admin invitation flow issues and improve STORAGE_PATH documentation ([41bf6ff](https://github.com/8digit/picpeak/commit/41bf6ff884d5ef3181f95f3aa4a528434c23947a))
* resolve branding display issues and invitation parsing errors ([1931d73](https://github.com/8digit/picpeak/commit/1931d73b60d3419203cc8b420841abbfc9e14d2d))
* Resolve branding display issues and invitation parsing errors (v2.2.1) ([#86](https://github.com/8digit/picpeak/issues/86)) ([d7ecf83](https://github.com/8digit/picpeak/commit/d7ecf83d32ec6608280b96e6cdee48e9a0ad0afa))
* resolve code quality issues and add missing i18n keys ([#162](https://github.com/8digit/picpeak/issues/162), [#163](https://github.com/8digit/picpeak/issues/163)) ([329d224](https://github.com/8digit/picpeak/commit/329d224846d3f4eefa31e42337f34047c267d578))
* resolve feedback validation issues from GitHub issue [#16](https://github.com/8digit/picpeak/issues/16) ([f26beca](https://github.com/8digit/picpeak/commit/f26becad1dfa72c62b6ecec491be025644426d67))
* resolve feedback validation issues from GitHub issue [#16](https://github.com/8digit/picpeak/issues/16) ([67ff415](https://github.com/8digit/picpeak/commit/67ff4158404347bc7c13dee5b4e13260eb0e743d))
* resolve GitHub issues [#4](https://github.com/8digit/picpeak/issues/4), [#8](https://github.com/8digit/picpeak/issues/8), [#9](https://github.com/8digit/picpeak/issues/9), and [#10](https://github.com/8digit/picpeak/issues/10) ([934d6dd](https://github.com/8digit/picpeak/commit/934d6ddc5847f65db6371a4043b764f6d4cd6c8b))
* resolve issues [#194](https://github.com/8digit/picpeak/issues/194), [#195](https://github.com/8digit/picpeak/issues/195), [#196](https://github.com/8digit/picpeak/issues/196), [#197](https://github.com/8digit/picpeak/issues/197) ([33af088](https://github.com/8digit/picpeak/commit/33af0885607799e0071e2e74a582c7eb396c9b83))
* resolve issues [#194](https://github.com/8digit/picpeak/issues/194), [#195](https://github.com/8digit/picpeak/issues/195), [#196](https://github.com/8digit/picpeak/issues/196), [#197](https://github.com/8digit/picpeak/issues/197) ([5ea4ef3](https://github.com/8digit/picpeak/commit/5ea4ef3cf36b06f9e6c9108f80bfe2e9a6470898))
* resolve issues [#194](https://github.com/8digit/picpeak/issues/194), [#195](https://github.com/8digit/picpeak/issues/195), [#196](https://github.com/8digit/picpeak/issues/196), [#197](https://github.com/8digit/picpeak/issues/197) ([33483cf](https://github.com/8digit/picpeak/commit/33483cf32dfae57f8da51c0765353792239135f9))
* resolve issues [#194](https://github.com/8digit/picpeak/issues/194), [#195](https://github.com/8digit/picpeak/issues/195), [#196](https://github.com/8digit/picpeak/issues/196), [#197](https://github.com/8digit/picpeak/issues/197) ([cd00bc1](https://github.com/8digit/picpeak/commit/cd00bc13d4e02a86a0f1742ed1f11f064614b8da))
* resolve mixed light/dark mode styling in admin UI ([#175](https://github.com/8digit/picpeak/issues/175)) ([f8c8abd](https://github.com/8digit/picpeak/commit/f8c8abd70bbae35d6cd519894624ade33b5115a8))
* resolve multiple issues from GitHub issue [#14](https://github.com/8digit/picpeak/issues/14) ([e91209f](https://github.com/8digit/picpeak/commit/e91209f7cb38a5b840e74ed6acd8d490ef9d2294))
* resolve port configuration issues and database column mismatch ([6de64a1](https://github.com/8digit/picpeak/commit/6de64a1df18932badd7bb1b9928d09e9477f0c3f))
* resolve translation interpolation issue for download button ([c1e10f1](https://github.com/8digit/picpeak/commit/c1e10f14a30797c76169c2531de5d04976ee4888))
* respect allowed_file_types setting for upload validation ([#203](https://github.com/8digit/picpeak/issues/203)) ([fe07a14](https://github.com/8digit/picpeak/commit/fe07a148f1d998c0be00377c1f8b4eca3908305c))
* respect optional email settings in event creation ([831ea6a](https://github.com/8digit/picpeak/commit/831ea6a3bccfae4ec00ce1f619967b91b85150ce))
* respect optional email settings in event creation ([#217](https://github.com/8digit/picpeak/issues/217)) ([9c44a0e](https://github.com/8digit/picpeak/commit/9c44a0ebfa527fa133512eb7f2f03335a2377aaa))
* restore aspect-ratio layouts and improve hero image quality ([#180](https://github.com/8digit/picpeak/issues/180)) ([3974ba5](https://github.com/8digit/picpeak/commit/3974ba5de5a6605ad906608d3e4d61620a215059))
* restore aspect-ratio layouts and improve hero image quality ([#180](https://github.com/8digit/picpeak/issues/180)) ([5cef7fd](https://github.com/8digit/picpeak/commit/5cef7fdd188389512bc4b55ae61536c8b1219eb8))
* **security:** invalidate tokens on password change, enforce session timeout, fix role update ([85a60a2](https://github.com/8digit/picpeak/commit/85a60a2dc7526aa6b673e2a04e9fdfba7de7117f))
* **security:** resolve all npm audit vulnerabilities ([4272618](https://github.com/8digit/picpeak/commit/4272618b3f7fcb06aaca14fb724a6a7733251f24))
* **security:** resolve Docker image CVEs for code scanning alerts ([cbecb93](https://github.com/8digit/picpeak/commit/cbecb9323cf4b80c800326de14f6df73f60147c1))
* **security:** token invalidation on password change, session timeout enforcement ([0a3a537](https://github.com/8digit/picpeak/commit/0a3a53763c9f3caef9fdceccf9fdbfdefe9bd8bf))
* **security:** upgrade Alpine base image to fix libpng and c-ares CVEs ([b706eeb](https://github.com/8digit/picpeak/commit/b706eeb5d332e9618706193976a7241aee53d879))
* **setup/native:** correct repo URL, paths, and systemd for native install; support sqlite in production knex config ([87b8414](https://github.com/8digit/picpeak/commit/87b8414e449802db6dc9f762453f7672616b83c9))
* **setup/native:** Debian 12 compatibility (reliable RAM detection, sudo-less run_as_user, git safe.directory); ensure SQLite data dir; use user for migrate ([dc482e6](https://github.com/8digit/picpeak/commit/dc482e614a5fbac44c6570d812669511301a4403))
* **setup/native:** handle forced updates safely by fetch+checkout/reset instead of pull; stable on rewritten histories ([3697344](https://github.com/8digit/picpeak/commit/3697344cd0add28b4da71c3b33e2ccc0a96f50f9))
* **setup/update:** detect native installs first (/opt/picpeak/app/backend or systemd unit); avoid false docker updates on root ([adf576f](https://github.com/8digit/picpeak/commit/adf576fbe17f40c13c1d77dd9751f2e9dbf523a1))
* show upload button in mobile topbar instead of sidebar ([ae181cf](https://github.com/8digit/picpeak/commit/ae181cf92fc9c1e85cad7a7b843a4d83cec636ac)), closes [#113](https://github.com/8digit/picpeak/issues/113)
* stabilize uploads and guest feedback filters ([aaaf598](https://github.com/8digit/picpeak/commit/aaaf59817b3978635d2282c006853e183ab944d4))
* sync backend package-lock.json for security deps ([bb81fa5](https://github.com/8digit/picpeak/commit/bb81fa5f4b5f1bd927a02470ce80a13c4f53443f))
* sync backend package-lock.json with security dep updates ([03e1989](https://github.com/8digit/picpeak/commit/03e19893b3532a27aa59e7b834d53c6a2b52b7cd))
* sync header_style DB column with theme editor selections ([#158](https://github.com/8digit/picpeak/issues/158)) ([2288309](https://github.com/8digit/picpeak/commit/228830939553fd32c250704bb89a8ce233324d25))
* sync header_style DB column with theme editor selections ([#158](https://github.com/8digit/picpeak/issues/158)) ([a19e7c4](https://github.com/8digit/picpeak/commit/a19e7c40a200ff822c947a83349ed07ccf4e1b01))
* **theme:** apply custom colors/fonts in Story & Premium layouts, fix create-page reset loop ([7bdab1c](https://github.com/8digit/picpeak/commit/7bdab1c3d183d5dcc8e2e584b8031c802f34d538))
* update docker-compose to docker compose and add ADMIN_PASSWORD to .env.example ([#189](https://github.com/8digit/picpeak/issues/189)) ([a4c6248](https://github.com/8digit/picpeak/commit/a4c624802b2926a16adcf0472a3041562f9b2f48))
* update Gitea mirror workflow to selectively remove scripts ([296430e](https://github.com/8digit/picpeak/commit/296430e4d7e01a6be031dbb89dd25f563b163a97))
* update GitHub mirror action to support fine-grained personal access tokens ([827eb48](https://github.com/8digit/picpeak/commit/827eb4819b7da6171d48613963d176399cad80c6))
* update packages to fix security vulnerabilities ([8097a0c](https://github.com/8digit/picpeak/commit/8097a0cb530bd8003597cde81606231efadb0bf5))
* update security policy with private reporting channels ([7f77362](https://github.com/8digit/picpeak/commit/7f7736282f534adf4b9d5331d841a1f0bff7341c))
* update security policy with proper contact email and private reporting ([67b0f32](https://github.com/8digit/picpeak/commit/67b0f32456d0216e4c685a104c680fa5a5fd578f)), closes [#223](https://github.com/8digit/picpeak/issues/223)
* use actual photo aspect ratios in masonry columns mode ([#146](https://github.com/8digit/picpeak/issues/146)) ([8711f96](https://github.com/8digit/picpeak/commit/8711f967a15f5d57f6ad01bfdbd8d33f9ee96abc))
* use CSS Columns for gap-free mosaic layout ([#146](https://github.com/8digit/picpeak/issues/146)) ([821d329](https://github.com/8digit/picpeak/commit/821d3296ea4b6bde499e5497d258f15ab8dd1dbc))
* use photo dimensions for mosaic aspect ratios ([#146](https://github.com/8digit/picpeak/issues/146)) ([27ff51e](https://github.com/8digit/picpeak/commit/27ff51e7a1217848859b47940bc88caa6f1fb20f))
* use Release Please extra-files instead of sync-versions job ([fe7d45d](https://github.com/8digit/picpeak/commit/fe7d45dd122b2dca1b2a21ba5c86d32b9a193074))
* video upload media type, select all, and dimension repair ([#203](https://github.com/8digit/picpeak/issues/203), [#220](https://github.com/8digit/picpeak/issues/220), [#180](https://github.com/8digit/picpeak/issues/180)) ([fc75bcd](https://github.com/8digit/picpeak/commit/fc75bcdfc38673d6e4dd1cd943cfb4638d3a306c))
* video upload, select all, and dimension repair ([#203](https://github.com/8digit/picpeak/issues/203), [#220](https://github.com/8digit/picpeak/issues/220), [#180](https://github.com/8digit/picpeak/issues/180)) ([a0bb080](https://github.com/8digit/picpeak/commit/a0bb0805868e742f323b64312c3c5ef8ec408f68))
* watermark thumbnails, custom logo display, and German translations ([f843e4c](https://github.com/8digit/picpeak/commit/f843e4c25cef02eef354fd3ee25824e20e4f8fc8))
* watermark thumbnails, custom logo display, and German translations ([ea20446](https://github.com/8digit/picpeak/commit/ea20446a797a00cf45dbe7bf6f06574a79c4d8a6))
* watermark upload JSON parsing and image quality preservation ([0e3b50d](https://github.com/8digit/picpeak/commit/0e3b50d1b6a2dc532ebdc0981f81f77722e8f23a))


### Documentation

* **8digit:** session handoff — draft preview fix (2026-04-27) ([1f35c26](https://github.com/8digit/picpeak/commit/1f35c2691e8c8893e5aac89f85257661e1e55c02))
* **8digit:** session handoff — feedback + branding bug fixes (2026-04-26) ([e3b14ad](https://github.com/8digit/picpeak/commit/e3b14ad5bdb99cb7fe8a66810fdb8a408186c3f3))
* **8digit:** update HANDOFF + CHANGELOG for theme customization fixes (2026-04-27) ([cd9eed8](https://github.com/8digit/picpeak/commit/cd9eed8f5c83dd7d91ecf3bfbaf4110bb57cf0fa))
* add API_URL environment variable to .env.example files ([3e69579](https://github.com/8digit/picpeak/commit/3e69579f5a171b31a253b2a42bb033bf1b97387d))
* add External Media Library section to deployment guide ([#270](https://github.com/8digit/picpeak/issues/270)) ([2e1c71c](https://github.com/8digit/picpeak/commit/2e1c71c1ab073e488ac93e35337a2d3955dfef3d))
* add External Media Library section to deployment guide ([#270](https://github.com/8digit/picpeak/issues/270)) ([f6ca713](https://github.com/8digit/picpeak/commit/f6ca713a6edc8ba371db790daba05ecb85ea4872))
* add PUID/PGID note for Docker bind mounts to avoid permission issues ([0178e71](https://github.com/8digit/picpeak/commit/0178e71c67f198c6013ece52b0a2da0e2f1a6b2a))
* clarify VITE_API_URL usage; remove FRONTEND_API_URL; add storage vars; simplify compose mounts and external DB example (refs [#18](https://github.com/8digit/picpeak/issues/18)) ([758c085](https://github.com/8digit/picpeak/commit/758c085467e579e9f6b16df2298747fdddf2b205))
* **compose:** fix backend healthcheck path; remove frontend VITE_API_URL env and document /api proxy (refs [#18](https://github.com/8digit/picpeak/issues/18)) ([ecbc488](https://github.com/8digit/picpeak/commit/ecbc48815ded99a052ef057e69427c823cd34ece))
* emphasize importance of STORAGE_PATH in env example ([3397807](https://github.com/8digit/picpeak/commit/3397807670784e02cbe34a7a60db43c95d64f19c))
* fix deployment/admin routing and CORS guidance; add AGENTS.md; ignore AGENTS.md (refs [#18](https://github.com/8digit/picpeak/issues/18)) ([dad1787](https://github.com/8digit/picpeak/commit/dad1787aad8763637373e8eb87a47728d3d568cc))
* follow-up on PR [#15](https://github.com/8digit/picpeak/issues/15) — clarify VITE_API_URL usage, compose mounts, and admin routing (refs [#15](https://github.com/8digit/picpeak/issues/15)) ([e9171c7](https://github.com/8digit/picpeak/commit/e9171c71159cb41b91a099621bd2d7a7985dd239))
* **readme:** reflect new External Media reference mode and update roadmap (gallery feedback status) ([ee13556](https://github.com/8digit/picpeak/commit/ee13556c5cb4f24fe88e14fd00b821acf65b11cb))
* rewrite README — shorter, cleaner ([62643f2](https://github.com/8digit/picpeak/commit/62643f241b51dc1620e30a8c8767f52428c0314c))
* rewrite README — shorter, cleaner, less AI-sounding ([64f6061](https://github.com/8digit/picpeak/commit/64f606152fde2db9034fa9ffa08cc58623edf646))
* update deployment guide with GitHub Container Registry images ([2c9a56f](https://github.com/8digit/picpeak/commit/2c9a56f217218f0700817d150b3de115e9503baa))
* update HANDOFF and CHANGELOG for 2026-04-26 evening session ([3f0a955](https://github.com/8digit/picpeak/commit/3f0a955437962c8d37a75f5827a87f60a50de663))
